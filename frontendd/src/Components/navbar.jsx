    ...
    <React.Fragment>
      ...
      >
        <div className="group flex items-center shadow-lg rounded-md bg-[#2b2b2b] overflow-hidden cursor-pointer transition-all duration-500 ease-in-out gap-3 p-2 w-14 hover:w-34">
          ...
          <span className="font-serif text-lg whitespace-nowrap opacity-0 translate-x-[-10px] transition-all duration-500 ease-in-out group-hover:opacity-100 group-hover:translate-x-0 hover:text-[#dac5a7]">
            Projects
          </span>
        </div>

        {token? <IconButton icon={LogOut} onClick={LogOutFunction}/>:<IconButton icon={FaMessage} to={"https://wa.me/923072426590"} />}
      </div>
    </React.Fragment>
  );
};
